(function () {
  ...
  function formatArea(value) {
    if (value === null || value === undefined || value === "") return "площадь уточняется";
  ...
  function renderHouses() {
    ...
    if (!grid) return;
    grid.innerHTML = window.MAYSKI_DATA.houses.map((house) => `
  ...
  window.MAYSKI_UI = { formatArea, formatPrice, getLotStatusLabel, initHeader, renderHouses, showToast };
})();
